...
$(function () {
    ...
    function bulbGlow() {
        $("#bulb-1, #bulb-2, #bulb-3, #bulb-4, #bulb-5, #bulb-6, #bulb-7, #bulb-1-full, #bulb-2-full, #bulb-3-full, #bulb-4-full, #bulb-5-full, #bulb-6-full, #bulb-7-full").fadeOut(0);
        $("#bulboff, #bulboff-full").delay(0).fadeIn(0);
        $("#bulbon, #bulbon-full").fadeIn(100, bulbOff1);

    };
    function bulbGlow1() {
        $("#bulbon, #bulbon-full").fadeIn(100, bulbOff2);

    };
    function bulbGlow2() {
        $("#bulbon, #bulbon-full").fadeIn(100, showflowouts);
    ...
    function bulbOff1() {
        $("#bulbon, #bulbon-full").fadeOut(0);

        $("#bulboff, #bulboff-full").delay(300).fadeIn(50, bulbGlow1);
    };
    function bulbOff2() {
        $("#bulbon, #bulbon-full").fadeOut(0);

        $("#bulboff, #bulboff-full").delay(700).fadeIn(50, bulbGlow2);
    };
    function bulbOff() {
        $("#bulbon, #bulbon-full").fadeOut(0);
        $(".vp, .hp, .ap, .wf, .mt, .vt").fadeOut(1000);
        $("#bulboff, #bulboff-full").fadeIn(100);
    };
    function bulb1() {
        $("#bulb-1, #bulb-1-full").delay(500).fadeIn(500);
        $("#bulb-2, #bulb-2-full").delay(1000).fadeIn(500);
        $("#bulb-3, #bulb-3-full").delay(1500).fadeIn(500);
        $("#bulb-4, #bulb-4-full").delay(2000).fadeIn(500);
        $("#bulb-5, #bulb-5-full").delay(2500).fadeIn(500);
        $("#bulb-7, #bulb-7-full").delay(3000).fadeIn(500);
        $("#bulb-6, #bulb-6-full").delay(3500).fadeIn(500, logoSlider);
    };
...
// CUSTOME COMMON JQUER
	...
	parallax.studio.onload = function () {
        //resetAllVideos();
        $('#studio').removeAttr("style", "position:absolute");
    ...
    parallax.holography.onload = function () {
        ...
        mediaPlayer1 = document.getElementById('holo-video');
        mediaPlayer9 = document.getElementById('presenter-video');
        mediaPlayer9.src = "media/webpresenter-alpha.mp4";
	...
	parallax.animation.onload = function () {
        ...
        setTop("services", "services");
		 setBottom("wayfinding", "wayfinding");
       // setRight("productdes", "Home");
       // setBottom("holography", "Home");
